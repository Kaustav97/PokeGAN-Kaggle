...
def generator(input, random_dim, is_train, reuse=False):
    ...
    with tf.variable_scope('gen') as scope:
        ...
        # 8*8*256
        # Convolution, bias, activation, repeat!
        conv2 = tf.layers.conv2d_transpose(act1, c8, kernel_size=[5, 5], strides=[4, 4], padding="SAME",
        ...
        # 32*32*64
        conv4 = tf.layers.conv2d_transpose(act2, c32, kernel_size=[5, 5], strides=[4, 4], padding="SAME",
                                           kernel_initializer=tf.truncated_normal_initializer(stddev=0.02),
                                           name='conv4')
